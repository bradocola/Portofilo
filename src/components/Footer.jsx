  ...
  return (
    <footer id="contact" className="footer">
      <div className="footer__links">
        <a href="https://www.linkedin.com/in/omar-nagy-work/" target="_blank" rel="noopener noreferrer" className="footer__item">
          <i className="fa-brands fa-linkedin"></i>
          <span>LinkedIn</span>
        </a>
        <a href="https://github.com/bradocola" target="_blank" rel="noopener noreferrer" className="footer__item">
          <i className="fa-brands fa-github"></i>
          <span>GitHub</span>
        </a>
        <a href="https://wa.me/+201014337548" target="_blank" rel="noopener noreferrer" className="footer__item">
          <i className="fa-brands fa-whatsapp"></i>
          <span>WhatsApp</span>
        </a>
        <a href="mailto:omar.badran.work@gmail.com" className="footer__item">
          <i className="fa-solid fa-envelope"></i>
          <span>Email</span>
        </a>
        <a href="https://leetcode.com/u/Bradocola/" target="_blank" rel="noopener noreferrer" className="footer__item">
