    ...
    <footer id="contact" className="footer">
      <div className="footer__grid">
        <div className="footer__col">
          <span className="footer__brand">Omar Nagy</span>
          <p className="footer__blurb">
            Computer Engineering student at Cairo University, building software and embedded
        ...
        <div className="footer__col">
          ...
          <div className="footer__connect-grid">
            <a href="https://www.linkedin.com/in/omar-nagy-work/" target="_blank" rel="noopener noreferrer" className="footer__link">
              <i className="fa-brands fa-linkedin"></i>
              <span>LinkedIn</span>
            </a>
            <a href="https://github.com/bradocola" target="_blank" rel="noopener noreferrer" className="footer__link">
              <i className="fa-brands fa-github"></i>
              <span>GitHub</span>
            </a>
            <a href="https://wa.me/+201014337548" target="_blank" rel="noopener noreferrer" className="footer__link">
              <i className="fa-brands fa-whatsapp"></i>
              <span>WhatsApp</span>
            </a>
            <a href="mailto:omar.badran.work@gmail.com" className="footer__link">
              <i className="fa-solid fa-envelope"></i>
              <span>Email</span>
            </a>
            <a href="https://leetcode.com/u/Bradocola/" target="_blank" rel="noopener noreferrer" className="footer__link">
              <svg viewBox="0 0 95 111" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="footer__bottom">
        <p className="footer__copy">© {new Date().getFullYear()} Omar Nagy</p>
      </div>
    </footer>
  )
}
